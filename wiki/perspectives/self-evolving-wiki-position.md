...
# Position — 살아 있는 Wiki는 공동체의 검증 가능한 관점이어야 한다
...
- `CLM-DCFACC957266`: 관점과 사실 원장 분리
- `CLM-DA7C92E9A901`: 관찰·조향 가능한 인간-Agent 협업
- `CLM-CB6E34C87DA3`: atomic claim provenance
- `CLM-F464CCF0AA1A`: benchmark-gated self-evolution
- `CLM-EC52C0576A28`: 사용자 제어형 Wiki 기억 의존도
