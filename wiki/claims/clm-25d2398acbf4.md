...
description: "주장 CLM-25D2398ACBF4의 범위·생명주기·증거 성숙도 기록."
...
> 기록된 주장: Codex의 프로젝트 지침 결합 용량 기본값은 32 KiB이며, 한도에 도달하면 추가 지침 파일을 더하지 않는다.
...
|---|---|---|---:|---|
| `supports` | [출처 SRC-228828E53C40](../sources/src-228828e53c40.md) | `How Codex discovers guidance: size limit paragraph` | 4 | `agent:codex` |
