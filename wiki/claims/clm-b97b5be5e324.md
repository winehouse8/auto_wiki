...
description: "주장 CLM-B97B5BE5E324의 범위·생명주기·증거 성숙도 기록."
...
> 기록된 주장: Codex는 선택된 프로젝트 지침을 루트에서 현재 디렉터리 순으로 결합하므로 더 가까운 디렉터리의 지침이 뒤에 놓여 앞선 지침을 재정의할 수 있다.
...
|---|---|---|---:|---|
| `supports` | [출처 SRC-228828E53C40](../sources/src-228828e53c40.md) | `How Codex discovers guidance: Merge order` | 4 | `agent:codex` |
