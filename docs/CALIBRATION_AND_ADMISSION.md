...
3. 정확 레이블 일치율 외에 등급별 혼동 행렬과 도메인별 오류 분석
4. 철회·수정·철회됨 상태를 다루는 실제 어댑터의 장애·오래된 캐시 fixture
5. DOI가 없고 canonical URL이 변하는 웹·YouTube·dataset·법령 사례
6. 재배포 기사, 보도자료, 공유 데이터셋·모델 계열처럼 독립성 판정이 어려운 사례
