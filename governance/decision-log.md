...
## [2026-07-12] ADR-006 | Close the loop without granting an external executor

- 결정: interest cadence → bounded campaign → planned-only runtime → quarantine/admission → provenance ledger → integrated release gate를 연결한다.
...
## [2026-07-12] ADR-007 | Pin migration exceptions and evaluation fixtures
...
## [2026-07-12] ADR-008 | A v4 pass is not production certification
